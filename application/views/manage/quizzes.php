        ...
        <div class="col-sm-12">
            <table class="table table-bordered">
                ...
                <?php foreach($quizzes as $quiz):?>
                    <tr><td><?php echo $quiz->track_id; ?></td><td><?php echo $quiz->lesson_name; ?></td><td><?php echo $quiz->quiz_name; ?></td><td><?php echo $quiz->quiz_date; ?></td><td><a onclick="return confirm('are you sure you want to delete this quiz?')" href="<?php echo site_url('manage/delete_quiz/' . $quiz->quiz_id); ?>">Delete</a></td></tr>
                    <?php endforeach;?>
            </table>
        </div>
    </div>
