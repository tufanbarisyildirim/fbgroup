            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="alert alert-warning">
                        ...
                        <strong>Don't worry!</strong> This page is connecting to facebook to fetch documents. So, it may loads slowly.
                    </div>
                        ...
                        <tbody>
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td><a target="_blank" href="<?php echo $file['download_link']; ?>"><?php echo $file_name; ?></a><br />
