...
<!--script type="text/javascript">
	document.write("<div id='lights' style='position:absolute;width:956px;height:180px;top:-20px;background:url(<?php echo assets_url() . '/images/'; ?>light.png) no-repeat;left:50%;margin-left:-478px'></div>")
